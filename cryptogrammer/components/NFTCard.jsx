      ...
      >
        <div className="relative w-full h-52 sm:h-36 xs:h-56 minmd:h-60 minlg:h-300 rounded-2xl overflow-hidden">
          <Image
            layout="fill"
            objectFit="cover"
            className="object-fill layout-auto"
        ...
        <div className="mt-3 flex flex-col">
          ...
          <div className="flexBetween mt- minlg:mt-3 flex-row xs:flex-col xs:items-start xs:mt-3 ">
            <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-sm minlg:text-xs">
              {nft.price}
